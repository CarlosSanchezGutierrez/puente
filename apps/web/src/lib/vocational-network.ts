...
export const vocationalProfiles: VocationalProfile[] = [
...

  {
      ...
      credential: "Licenciatura en Arquitectura (ARQ)",
      institution: "Instituto Tecnológico y de Estudios Superiores de Monterrey (ITESM)",
...

  {
    ...
    credential: "Ing. Electrónica | Maestría en Electrónica | PhD en Educación | Ex directora y consejera IEEE",
    institution: "IEEE Sección Monterrey | Women in Semiconductor Nuevo León",
    family: "Ingenierías y Ciencias",
    city: "Monterrey",
    role: "Directiva académica",
...

  {
    ...
    credential: "Ingeniería en Robótica y Sistemas Digitales (IRS)",
    institution: "Instituto Tecnológico y de Estudios Superiores de Monterrey (ITESM)",
    family: "Ingenierías y Ciencias",
    city: "Monterrey",
    role: "Mentor universitario",
